<h2><a href="https://www.geeksforgeeks.org/problems/subset-sums2234/1?page=1&category%5B%5D=Recursion&sortBy=submissions">Subset Sums</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><div class="entry-content">
<p><span style="font-size: 14pt;">Given an array <strong><code>arr</code> </strong>of integers, return the sums of all subsets in the list.&nbsp; Return the sums in any order.</span></p>
